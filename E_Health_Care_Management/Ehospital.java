package E_Health_Care_Management;
...
class Info {
	...
	void patient() {
		System.out.println("Enter the patient's file name: ");
		...
		try {
			...
			// Note that write() does not autometiclly
			...
			bufferedWriter.write("Contect Number : " + contact);
			bufferedWriter.newLine();
	...
	void diagnos() {
		...
		getCurrentTimeUsingDate();
		System.out.print("\n\nEnter the patient's name to be opened : ");
		String fileName = scan.next();
		...
		try {
			...
			System.out.print("Adding more information to patient's file.................no : " + dadm);
			...
			System.out.println("Error wrting or Reading to file '" + fileName + "'");
		}
	}
	...
	void bill() {
		...
		//This will referance one line at a time
		String line = null;
		try {
			//FileReader reads text files in the default encoding.
			FileReader fileReader = new FileReader(fileName+".txt");
	...
	void exit() {
		...
		System.out.print("\t\t\t\t\t|                                                                                       |\n");
		System.out.print("\t\t\t\t\t|                                                                                       |\n");
		System.out.print("\t\t\t\t\t|                          -Brought To You by Omkar Pathak                              |\n");
		System.out.print("\t\t\t\t\t|_______________________________________________________________________________________|\n");
		System.out.print("\t\t\t\t\t\n\n\n\n\t\t\t\t\t");
		System.exit(0);
	}
